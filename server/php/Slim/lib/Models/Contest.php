...
class Contest extends AppModel
{
    ...
    public function processOrder($args)
    {
        ...
        if (!empty($contest)) {
            ...
            insertTransaction($authUser['id'], $adminId['id'], $contest->id, 'Contest', \Constants\TransactionType::ContestFeaturesUpdatedFee, $args['payment_gateway_id'], $amount, 0, 0, 0, 0, $contest->id, $contest->zazpay_gateway_id);
