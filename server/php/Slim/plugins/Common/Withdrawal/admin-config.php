    ...
    'user_cash_withdrawals' => array(
        'listview' => array(
            ...
            'listActions' => array(
                0 => 'edit',
                1 => 'show',
				2 => '<pay-outs-approve entry="entry"  entity="entity"></pay-outs-approve>',
				3 => '<pay-outs-reject entry="entry"  entity="entity"></pay-outs-reject>'
            ) ,
            'batchActions' => array(
                0 => '<batch-withdraw-success type="success" action="user_cash_withdrawals" selection="selection"></batch-withdraw-success>',
				1 => '<batch-withdraw-reject type="reject" action="user_cash_withdrawals" selection="selection"></batch-withdraw-reject>'
            ) ,
            'filters' => array(
                0 => array(
                    'name' => 'q',
