    ...
    try {
        ...
        if (empty($validationErrorFields)) {
            ...
            if ($reviews->class == 'QuoteBid') {
                ...
                $bids = Models\ProjectBid::with($enabledIncludes)->where('id', $reviews->foreign_id)->select('project_id', 'user_id')->whereHas('project', function ($q) {
            ...
            if ($reviews->class == 'Bid') {
                ...
                $emailFindReplace = array(
                    ...
                    '##PROJECT_URL##' => $_server_domain_url . '/project/' . $getprojectDetails->id . '/' . $getprojectDetails->slug
                );
        ...
        try {
            ...
            elseif ($reviews->class == 'Bid') {
                ...
                $emailFindReplace = array(
                    ...
                    '##REVIEWER##' => $getReviewer->username,
                    '##PROJECT_URL##' => $_server_domain_url . '/project/' . $bidDetails->project->id . '/' . $bidDetails->project->slug
                );
