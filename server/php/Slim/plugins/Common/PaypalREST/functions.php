...
{
    $paymentGatewaySettings = Models\PaymentGatewaySetting::where('payment_gateway_id', \Constants\PaymentGateways::PayPalREST)->get();
    ...
    $sanbox_mode = 'live';
    $payment_gateways = Models\PaymentGateway::select('is_test_mode')->where('id', \Constants\PaymentGateways::PayPalREST)->first();
